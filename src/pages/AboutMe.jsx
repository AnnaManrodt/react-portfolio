...
export default function AboutMe() {
    ...
    return (
        <div className="main_container">
            <img className="profileImg" src={myImage} alt="Img of me" />
            <div className="mainTextContent">
            <div>
                <Typography variant="h4">About Me</Typography>
                <Typography className="textContent"  class="indent">
            ...
            <div>
                <Typography variant="h4">My Philosophy</Typography>
                <Typography  class="indent">
